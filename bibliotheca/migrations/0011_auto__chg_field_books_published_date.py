...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Books.published_date'
        db.alter_column('bibliotheca_books', 'published_date', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Books.published_date'
        db.alter_column('bibliotheca_books', 'published_date', self.gf('django.db.models.fields.DateTimeField')())
