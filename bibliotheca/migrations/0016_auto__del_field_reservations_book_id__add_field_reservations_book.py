...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reservations.book_id'
        db.delete_column('bibliotheca_reservations', 'book_id_id')

        # Adding field 'Reservations.book'
        db.add_column('bibliotheca_reservations', 'book',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bibliotheca.Books']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Reservations.book_id'
        db.add_column('bibliotheca_reservations', 'book_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bibliotheca.Books']),
                      keep_default=False)

        # Deleting field 'Reservations.book'
        db.delete_column('bibliotheca_reservations', 'book_id')
